    ...
    var extend = function (obj) {
        ...
        imaPlugin = function (options, readyCallback) {
            ...
            player.ima.initializeAdDisplayContainer = function () {
                adDisplayContainerisInitialized = true;
            ...
            player.ima.requestAds = function () {
                if (!adDisplayContainerisInitialized) {
                    adDisplayContainer.initialize();
                }
            ...
            player.ima.onAdsManagerLoaded_ = function (adsManagerLoadedEvent) {
                if (settings.debug) {
                    window.console.log("AdsManager loaded");
                ...
                player.trigger('google.ima.adsManagerLoaded');
                if (!autoPlayAdBreaks) {
                    try {
            ...
            player.ima.onAdError_ = function (adErrorEvent) {
                ...
                player.trigger('adserror', adErrorEvent);
            };
            ...
            player.ima.isInitialized = function(){
                return isInitialized;
            };

            player.ima.reset = function () {
                if (settings.debug) {
                    window.console.log('Reseting IMA videojs plugin');
                }
                ...
                contentComplete = false;
                allAdsCompleted = false;
                var eventsToUnsubscribe = ['play', 'ended', 'fullscreenchange', 'volumechange'];
                for (var e in eventsToUnsubscribe) {
                    player.off(eventsToUnsubscribe[e]);
                }
                isInitialized = false;
            };
            ...
            /**
             * True if the AdDisplayContainer has been isInitialized. False otherwise.
             */
            var adDisplayContainerisInitialized = false;
